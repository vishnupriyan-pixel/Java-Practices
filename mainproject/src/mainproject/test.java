...
//		WebDriver driver = new  FirefoxDriver();
		...
		WebElement link3 = driver.findElement(By.cssSelector("#details-button"));
		driver.manage().timeouts().implicitlyWait(2000,TimeUnit.MILLISECONDS);
		
		String ActualData = "Advanced";
		String ExpectedData = link3.getText();
//	  System.out.println(ExpectedData);
	     
        try {
	   		     Assert.assertEquals(ActualData, ExpectedData);
	   		     System.out.println("Advanced button is clicked : Pass");
	   	      }
		...
		link3.click();
		   ...
		   boolean  btn_adv = driver.findElement(By.xpath("//*[@id=\"details-button\"]")).isEnabled();
		   boolean btn_adv1 = true;
		
		      try {
			   		 Assert.assertEquals(btn_adv, btn_adv1);
		  ...
		  ///proceed to link
		   WebElement link4 = driver.findElement(By.cssSelector("#proceed-link"));
		   driver.manage().timeouts().implicitlyWait(2000,TimeUnit.MILLISECONDS);
		   link4.click();
		   Thread.sleep(1000);
		   ActualData = "https://www.testandquiz.com/selenium/testing.html";
		   ExpectedData = driver.getCurrentUrl();
		    driver.manage().timeouts().implicitlyWait(1500,TimeUnit.MILLISECONDS);
		     
		        try{
		                Assert.assertEquals(ActualData, ExpectedData);
		                System.out.println("\nSample Webpage site: Pass");
		           }
		        catch(AssertionError e){
		    	        System.out.println("Fail");	
		           }
		...
		link1.click();
		Thread.sleep(1000);
		 ActualData = "https://www.javatpoint.com/";
	     ExpectedData = driver.getCurrentUrl();
	    driver.manage().timeouts().implicitlyWait(1500,TimeUnit.MILLISECONDS);
...
//		  System.out.println(ExpectedData);
              ...
              try {
		   		     Assert.assertEquals(ActualData, ExpectedData);
		   		     System.out.println("Changes color when button clicked : Pass");
		   	      }
		      catch(AssertionError e) {
		   		     System.out.println("Fail");
		   	      }
