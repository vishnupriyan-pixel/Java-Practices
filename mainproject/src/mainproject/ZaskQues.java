...
/////Maximum no.of.tags fields check
	...
	public void bounty_flag() throws InterruptedException {
		...
		Thread.sleep(1000);
		flag_type1.click();
		String flag_icon_selected = "-169px -72px";
		String flag_icon_unselected = "-169px -48px" ; 
		
		if(flag_icon.getCssValue("background-position") != null) {
			Assert.assertTrue(flag_icon_selected.matches("-169px -72px|-169px -48px"));
		} 
		else { 
			Assert.assertTrue(flag_icon_unselected.matches("-169px -72px|-169px -48px"));
		}
	...
	/////------------selecting Rude or abusive under the flag----------------------/////
		...
		assertEquals(flag_type,flag_type1.getText());
		flag_type1.click();
		flag_icon_selected = "-169px -72px";
		flag_icon_unselected = "-169px -48px" ; 
	...
	public void bounty_link() throws InterruptedException {
		...
		assertEquals(url_present, driver.getCurrentUrl());
		Thread.sleep(2000);   
		driver.navigate().back();
	}
